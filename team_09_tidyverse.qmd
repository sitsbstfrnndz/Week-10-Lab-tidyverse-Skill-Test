...
-   **Overplotting**: Multiple data points with the same value can overlap, making it difficult to see the exact number of occurrences. 
-   **Lack of Distribution Information**: Does not provide a clear view of the data distribution within each experiment.
